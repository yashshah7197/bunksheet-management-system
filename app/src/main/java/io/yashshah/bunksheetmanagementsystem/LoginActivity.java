...
public class LoginActivity extends AppCompatActivity
  ...
  private void setupViews() {
    ...
    mGoogleSignInImageButton = (AppCompatImageButton) findViewById(R.id.imageButton_google_login);
  ...
  private void signInWithEmailPassword() {
    if (TextUtils.isEmpty(mEmailInputLayout.getEditText().getText()) || TextUtils.isEmpty(
        mPasswordInputLayout.getEditText().getText())) {
      showSignInFailedAlertDialog();
      return;
    }
