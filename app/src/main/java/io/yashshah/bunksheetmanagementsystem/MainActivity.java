...
public class MainActivity extends AppCompatActivity implements DrawerActionsInterface {
  ...
  private void setupViews() {
    ...
    mActionBarDrawerToggle =
        new ActionBarDrawerToggle(this, mDrawerLayout, mToolbar, R.string.open_drawer,
  ...
  private void loadUserInfo() {
    mUserDatabaseReference = mDatabase.getReference().child("Users").child(mCurrentUser.getUid());
  ...
  private void updateNavigationDrawer(String name, String year, String division, String rollNo,
    ...
    if (privilegeLevel > User.PRIVILEGE_STUDENT) {
      mNavigationView.getMenu().findItem(R.id.navigation_approve_bunksheets).setVisible(true);
      mNavigationView.getMenu().findItem(R.id.navigation_bunksheets).setVisible(false);
      mNavigationView.getMenu().findItem(R.id.navigation_approved_bunksheets).setVisible(true);
      mNavigationView.getMenu().findItem(R.id.navigation_declined_bunksheets).setVisible(true);
    } else {
      mNavigationView.getMenu().findItem(R.id.navigation_approve_bunksheets).setVisible(false);
    }
  }
  ...
  private void goToStartupFragment() {
    ...
    if (privilegeLevel <= User.PRIVILEGE_STUDENT) {
      ...
      selectNavigationItem(mNavigationView.getMenu().findItem(R.id.navigation_approve_bunksheets));
    }
  }
  ...
  private void selectNavigationItem(MenuItem item) {
    ...
    switch (item.getItemId()) {
      ...
      case R.id.navigation_declined_bunksheets:
        fragment = DeclinedBunksheetsFragment.newInstance();
        mNavigationView.setCheckedItem(R.id.navigation_declined_bunksheets);
        setTitle(item.getTitle());
        mDrawerLayout.closeDrawers();
        break;
    ...
    if (fragment != null) {
      ...
      fragmentManager.beginTransaction().replace(R.id.frameLayout_fragments, fragment).commit();
    }
  }
  ...
  @Override public void selectDrawerItem(int itemId) {
